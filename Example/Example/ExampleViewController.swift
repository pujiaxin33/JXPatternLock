...
class ExampleViewController: UIViewController, PatternLockViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        pathConifg.initGridClosure = {(matrix) -> PatternLockGrid in
            ...
            let outerStrokeColorStatus = GridPropertyStatus<UIColor>(normal: colorWithRGBA(r: 18, g: 143, b: 235, a: 1), connect: colorWithRGBA(r: 18, g: 143, b: 235, a: 1), error: UIColor.red)
            let outerFillColorStatus = GridPropertyStatus<UIColor>(normal: nil, connect: colorWithRGBA(r: 18, g: 143, b: 235, a: 1), error: UIColor.red)
